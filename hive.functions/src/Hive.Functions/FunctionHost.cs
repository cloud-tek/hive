...
public class FunctionHost : IFunctionHost
{
  ...
  /// <inheritdoc />
  public bool IsReady => true; // Functions don't use readiness probes

  /// <inheritdoc />
  public bool IsStarted => host != null; // Simple started check

  /// <inheritdoc />
  public IMicroServiceLifetime Lifetime => throw new NotSupportedException("Lifetime is managed by Azure Functions runtime");

  /// <inheritdoc />
  public MicroServicePipelineMode PipelineMode => MicroServicePipelineMode.None; // Functions don't use pipeline modes
  ...
  /// <inheritdoc />
  IMicroService IMicroService.RegisterExtension<TExtension>()
  {
  ...
  /// <inheritdoc />
  Task<int> IMicroService.RunAsync(IConfigurationRoot configuration, params string[] args)
  {
    throw new NotSupportedException("Use RunAsync(CancellationToken) instead for Azure Functions");
  }

  /// <inheritdoc />
  Task IMicroService.InitializeAsync(IConfigurationRoot? configuration, params string[] args)
  {
    host = CreateHostBuilder();
